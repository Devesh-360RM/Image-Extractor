...
async function verifyWordPressFullSizeUrl(candidateUrl, timeoutMs = 2500) {
...
export {
  cleanStoreNameString,
  cleanWordPressImageUrl,
  discoverProductLinks,
  extractCollectionFromUrl,
  extractGenericPlatformImages,
  extractProductFromHtml,
  extractProductFromUrl,
  extractShopifyImages,
  extractStoreName,
  extractWooCommerceImages,
  getLargestFromSrcset,
