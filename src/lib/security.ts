/**
 * Security utilities: SSRF prevention, IP sanitization, and URL safety checks.
 * Disallows localhost, private IPv4/IPv6 ranges, cloud metadata endpoints, and non-HTTP protocols.
 */
...
export function validatePublicUrl(rawUrl: string): UrlValidationResult {
...
export const SECURE_FETCH_HEADERS = {
  "User-Agent":
